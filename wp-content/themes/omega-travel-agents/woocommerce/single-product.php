...
$omega_travel_agents_sidebar_column_class = ($omega_travel_agents_layout === 'right-sidebar') ? 'column-order-1' : 'column-order-2';
?>
	...
	<div class="wrapper">
		<div class="column-row <?php echo esc_attr($omega_travel_agents_layout === 'no-sidebar' ? 'no-sidebar-layout' : ''); ?>">
			...
			<?php
					 ...
					 */
					if ($omega_travel_agents_layout !== 'no-sidebar') : do_action('woocommerce_sidebar'); endif;
