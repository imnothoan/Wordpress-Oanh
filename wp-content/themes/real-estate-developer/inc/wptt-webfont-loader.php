...
if ( ! class_exists( 'Real_Estate_Developer_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Real_Estate_Developer_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'real_estate_developer_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function real_estate_developer_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Real_Estate_Developer_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'real_estate_developer_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function real_estate_developer_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Real_Estate_Developer_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
