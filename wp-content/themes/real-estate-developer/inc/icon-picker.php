...
class Real_Estate_Developer_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'real-estate-developer' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $real_estate_developer_font_awesome_icon_array = real_estate_developer_font_awesome_icon_array();
                    foreach ($real_estate_developer_font_awesome_icon_array as $real_estate_developer_font_awesome_icon) {
                            $icon_class = $this->value() == $real_estate_developer_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($real_estate_developer_font_awesome_icon).'"></i>
                            <span class="real-estate-developer-social-class">'.esc_attr($real_estate_developer_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function real_estate_developer_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'real-estate-developer-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'real_estate_developer_customizer_script' );

if(!function_exists('real_estate_developer_font_awesome_icon_array')){
    function real_estate_developer_font_awesome_icon_array(){
