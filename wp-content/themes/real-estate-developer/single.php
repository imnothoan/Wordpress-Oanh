          ...
          <div class="navigation">
            <?php
              ...
              the_posts_pagination( array(
                'prev_text' => __( 'Previous page', 'real-estate-developer' ),
                'next_text' => __( 'Next page', 'real-estate-developer' ),
                'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'real-estate-developer' ) . ' </span>',
              ) );
            ?>
