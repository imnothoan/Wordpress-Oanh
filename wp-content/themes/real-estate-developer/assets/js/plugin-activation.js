jQuery(document).ready(function($) {
    'use strict';
    var this_obj = real_estate_developer_plugin_activate_plugin;

    $(document).on('click', '.real-estate-developer-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message real-estate-developer-plugin-install');
                button.addClass('button-primary real-estate-developer-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.real-estate-developer-recommended-plugins .real-estate-developer-activation-note').css('display','block');
    ...
    $(document).on('click', '.real-estate-developer-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .real-estate-developer-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .real-estate-developer-recommended-plugins').css('display','none');
    });
