    ...
    class Courtyard_Welcome_Screen {
        ...
        public function welcome_notice() {
            ...
            <div data-dismissible="courtyard-welcome-forever" class="updated notice notice-success is-dismissible welcome-notice">
                ...
                <p><?php printf( esc_html__( 'Welcome! Thank you for choosing %1$s ! To fully take advantage of the best our theme can offer please make sure you visit our %2$s welcome page%3$s.', 'courtyard' ),COURTYARD_THEME,'<a href="' . esc_url( admin_url( 'themes.php?page=courtyard-welcome' ) ) . '">', '</a>' ); ?></p>
                <p>
