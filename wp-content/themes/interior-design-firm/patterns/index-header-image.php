 ...
 * Slug: interior-design-firm/index-header-image
 * Categories: interior-design-firm, index-header-image
 */
?>
...
<h2 class="wp-block-heading has-text-align-center" style="text-transform:uppercase"><?php echo esc_html__('blog','interior-design-firm'); ?></h2>
<!-- /wp:heading --></div></div>
<!-- /wp:cover -->